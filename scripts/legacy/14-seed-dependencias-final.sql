-- Carga final de dependencias con siglas corregidas (máximo 10 caracteres)
...
('212', 'AGUSTÍN', 'AGUSTÍN CODAZZI', 'descentralizado', NULL, 0, 212, true, NULL),
('214', 'BOMBEROS', 'CUERPO DE BOMBEROS CHÍA', 'descentralizado', NULL, 0, 214, true, NULL),
('215', 'DEFENSA', 'DEFENSA CIVIL COLOMBIANA', 'descentralizado', NULL, 0, 215, true, NULL);
